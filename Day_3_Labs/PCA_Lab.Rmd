...
\
If you have time, repeat the PCA analysis, but use /cm/shared/courses/Bioinfo_Workshop/clownfish_data/output.hicov2.snps.only.vcf as yoru input file to plink.
\
\
