...
You should see your new file at the bottom (clownfish\_nooutliers.recode.vcf), about 8 MB.
...
This will create a file called clownfish\_outliersonly.recode.vcf that you can use as input to plink.
\
\
