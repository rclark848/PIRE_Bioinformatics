...
```
\
We want to calculate average LD for all pairs of loci with similar distance apart. Here, we'll round distance down to the nearest multiple of 0.25 $log_{10}$ basepairs apart:
```{r, eval=FALSE}
