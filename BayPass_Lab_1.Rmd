...
```
\
The program should only take ~1 minute to run. Type ls -ltrh to check and see that it is running properly. If it worked, you should see an output file titled output_BayPass.snps appear.
\
\
Arguments we used:
